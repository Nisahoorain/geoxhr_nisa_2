...
DB_HOST = 'ec2-15-156-80-22.ca--1.compute.amazonaws.com'
DB_USER = 'hayat'
...
EMAIL_CREDENTIALS = [
    {'address': 'nisa@i8is.com', 'password': 'nisai8is123??'},  # Add more email addresses and passwords here
]
...
engine = create_engine(
    'mysql+pymysql://hayat:Hayat_admin123@ec2-15-156-80-22.ca-central-1.compute.amazonaws.com/geoxhrdb')
    ...
    while True:
        for email_credentials in EMAIL_CREDENTIALS:
            ...
            try:
                ...
                # search_criteria = f'(SINCE 21-Jan-{year} BEFORE {current_date})'
